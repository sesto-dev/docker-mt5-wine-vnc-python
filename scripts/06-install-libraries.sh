...
if ! is_wine_python_package_installed "MetaTrader5==$metatrader_version"; then
    $wine_executable python -m pip install --no-cache-dir numpy==1.22.4 pandas==1.4.2 pytz flasgger rpyc python-json-logger prometheus_client flask MetaTrader5==$metatrader_version
fi
